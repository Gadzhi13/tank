...
class MotorController:
    ...
    def forward(self, speed=1):
        ...
        self.reverseRight.value = False
        self.driveLeft.value = 1.0 * float(speed)
        self.driveRight.value = 1.0 * float(speed)
    ...
    def forward_left(self, speed=1):
        ...
        self.forwardRight.value = True
        self.reverseRight.value = False
        self.driveLeft.value = 0.2 * float(speed)
        self.driveRight.value = 0.8 * float(speed)
    ...
    def forward_right(self, speed=1):
        ...
        self.forwardRight.value = True
        self.reverseRight.value = False
        self.driveLeft.value = 0.8 * float(speed)
        self.driveRight.value = 0.2 * float(speed)
